...
namespace Flatpack.Architecture.SharedData.Special.Time
{
    ...
    /// </summary>
    [UnityEngine.CreateAssetMenu(menuName = "Flatpack/Architecture/Shared Data/Special/Time/Smooth Delta Time", fileName = "SharedSmoothDeltaTime", order = 0)]
    internal class SharedSmoothDeltaTime: AbstractGenericSharedData<float>
    {
        public override float Value => UnityEngine.Time.smoothDeltaTime;
    }
}