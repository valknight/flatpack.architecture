...
namespace Flatpack.Architecture.SharedData.Special.Time
{
    ...
    /// </summary>
    [UnityEngine.CreateAssetMenu(menuName = "Flatpack/Architecture/Shared Data/Special/Time/Fixed Unscaled Delta Time", fileName = "SharedFixedUnscaledDeltaTime", order = 0)]
    internal class SharedFixedUnscaledDeltaTime: AbstractGenericSharedData<float>
    {
        public override float Value => UnityEngine.Time.fixedUnscaledDeltaTime;
    }
}